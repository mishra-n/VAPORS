...
def PrintableSummaryTableNoChain(table):
    ...
    rounded_table['N'] = np.log10(rounded_table['N'])
    rounded_table['2*Nerr'] = np.log10(2*rounded_table['Nerr'])
    # Reorder the columns
    rounded_table = rounded_table[['ion', 'tempname', 'wavelength', 'N', 'Nerr_low', 'Nerr_high', '2*Nerr', 'upper_limit', 'v', 'verr', 'b_tot', 'mass', 'z', 'absorber_number']]
